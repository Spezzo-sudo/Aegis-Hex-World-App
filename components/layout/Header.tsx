    ...
    return (
        <header className="bg-bg/80 backdrop-blur-sm border-b border-grid p-2 flex items-center justify-between z-20 shrink-0">
            ...
            <div className="px-4 flex items-center space-x-4">
                <button className="text-textMuted hover:text-primary transition-colors" aria-label="Settings">
                ...
                <button className="text-textMuted hover:text-primary transition-colors" aria-label="Player Profile">
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
